...
[`CreditScoringCalculated.avsc`](src/main/resources/avro/CreditScoringCalculated.avsc).
...
- [`AvroEventSerializer.kt`](src/main/kotlin/com/example/eventonboarding/adapters/outbound/messaging/AvroEventSerializer.kt)
- [`CreditScoringAvroMapper.kt`](src/main/kotlin/com/example/eventonboarding/adapters/outbound/messaging/CreditScoringAvroMapper.kt)
- [`RabbitDomainEventPublisher.kt`](src/main/kotlin/com/example/eventonboarding/adapters/outbound/messaging/RabbitDomainEventPublisher.kt)
- [`CreditScoringEventRegistryRoundTripIT.kt`](src/test/kotlin/com/example/eventonboarding/adapters/outbound/messaging/CreditScoringEventRegistryRoundTripIT.kt)
